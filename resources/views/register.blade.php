...
<body>
						...
						<div class="module-body">
							<div class="control-group">
								<div class="controls row-fluid">
									<input class="span12" @error('username') is-invalid @enderror type="text" id="inputEmail" placeholder="Username">
								</div>
							</div>
                            @error('username')
	...
	<div class="footer">
		<div class="container">
			...
			<b class="copyright">&copy; 2014 Patmayanti Kartini - EGrappler.com </b> All rights reserved.
		</div>
	</div>
